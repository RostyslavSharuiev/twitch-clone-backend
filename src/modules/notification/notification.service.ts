...
export class NotificationService {
  ...
  public async createStreamStart(userId: string, channel: User) {
    return await this.prismaService.notification.create({
      data: {
        message: `
        <b className='font-medium'>Don't miss!</b>
        <p>Join to stream on a channel
          <a href='/${channel.username}' className='font-semibold'>${channel.displayName}</a>.
        </p>`,
  ...
  public async createNewFollowing(userId: string, follower: User) {
    return await this.prismaService.notification.create({
      data: {
        ...
        <p>This user a
          <a href='/${follower.username}' className='font-semibold'>${follower.displayName}</a>.
        </p>`,
